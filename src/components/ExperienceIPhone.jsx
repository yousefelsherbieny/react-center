...
const cameraPositions = {
  ...
  camera: [
    -0.2816817625748494,
    -0.017347003209647244,
    0.3065631638865963,
    -0.036054404825409433,
    0.2469066391985735,
    0.01959945436374355,
  ],
  "action-button": [
    -0.88612937193474,
    -0.4964915367233699,
    0.003459464080557469,
    -0.015160554557400105,
    0.16977404132378549,
    0.0015889919991764756,
  ],
};

const cameraPositionsSmallScreen = {
  intro: [
    0.002795130059348545,
    -1.693376768600526,
    -1.4822074299185213,
    -0.001428821463540626,
    0.07667045240180789,
    0.02673756366323502,
  ],
  titanium: [
  ...
  camera: [
    ...
    -0.07123702938574586,
    0.23449640396985513,
    -0.0070772011186346715,
  ],
  "action-button": [
    -0.6259770949105332,
    -0.2529443173252278,
    -0.004747347677011271,
    -0.02485857424975495,
    0.1912378489798071,
    -0.013710853350645076,
  ],
};

const SMALL_SCREEN_THRESHOLD = 900;

export const ExperienceIPhone = ({ section }) => {
  ...
  useEffect(() => {
    if (introFinished) playTransition();
  }, [section]);
  ...
  return (
    <>
      ...
      <Gltf
        position={[0, 0, 0]}
        src={`${BASE_PATH}apple_iphone_15_pro_max_black.glb`}
      />
